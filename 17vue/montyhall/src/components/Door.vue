<template>
  <div class="door-area">
      <!-- será aplicado a classe selected caso a mesma esteja true e caso open esteja false-->
      <div class="door-frame" :class="{selected: selected && !open}">
          <!-- Gift será exibido caso open e hasGift sejam true-->
          <Gift v-if="open && hasGift"/>
      </div>

      <!-- em door a classe selected ficará variando entre true e false dependendo do click na porta-->
      <div class="door" 
         :class="{open}"
